 ...
 */
class SIMPLNXREVIEW_EXPORT EMsoftSO3SamplerFilter : public IFilter
{
public:
  ...
  static constexpr StringLiteral k_EnsembleAttributeMatrixPath_Key = "cell_ensemble_attribute_matrix_path";
