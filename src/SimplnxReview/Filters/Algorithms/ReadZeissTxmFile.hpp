...
struct SIMPLNXREVIEW_EXPORT ReadZeissTxmFileInputValues
{
 ...
 * @brief
 */
struct SIMPLNXREVIEW_EXPORT ReadZeissTxmFilterFileCache
{
  fs::path inputFile;
 ...
 */
class SIMPLNXREVIEW_EXPORT ReadZeissTxmFile
{
