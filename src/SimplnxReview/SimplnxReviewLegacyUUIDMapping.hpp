...
namespace nx::core
{
  static const AbstractPlugin::SIMPLMapType k_SIMPL_to_SimplnxReview
  {
    ...
    {nx::core::Uuid::FromString("cc76cffe-81ad-5ece-be2a-ce127c5fa6d7").value(), {nx::core::FilterTraits<ComputeSaltykovSizesFilter>::uuid}}, // GroupMicroTextureRegions
    {nx::core::Uuid::FromString("90f8e3b1-2460-5862-95a1-a9e06f5ee759").value(), {nx::core::FilterTraits<ComputeMicroTextureRegionsFilter>::uuid}}, // GroupMicroTextureRegions
    {nx::core::Uuid::FromString("49b2dd47-bb29-50d4-a051-5bad9b6b9f80").value(), {nx::core::FilterTraits<ComputeLocalAverageCAxisMisalignmentsFilter>::uuid}}, // GroupMicroTextureRegions
    {nx::core::Uuid::FromString("708be082-8b08-4db2-94be-52781ed4d53d").value(), {nx::core::FilterTraits<ComputeGroupingDensityFilter>::uuid}}, // GroupMicroTextureRegions
