...
{
/**
 * @class ComputeEquivalentDiameterCirclesFilter
 * @brief This filter determines the average C-axis location of each Feature
 */
class SIMPLNXREVIEW_EXPORT ComputeEquivalentDiameterCirclesFilter : public IFilter
{
public:
  ComputeEquivalentDiameterCirclesFilter() = default;
  ~ComputeEquivalentDiameterCirclesFilter() noexcept override = default;

  ComputeEquivalentDiameterCirclesFilter(const ComputeEquivalentDiameterCirclesFilter&) = delete;
  ComputeEquivalentDiameterCirclesFilter(ComputeEquivalentDiameterCirclesFilter&&) noexcept = delete;

  ComputeEquivalentDiameterCirclesFilter& operator=(const ComputeEquivalentDiameterCirclesFilter&) = delete;
  ComputeEquivalentDiameterCirclesFilter& operator=(ComputeEquivalentDiameterCirclesFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_CircleResolution_Key = "circle_resolution";
  static constexpr StringLiteral k_ZPlane_Key = "z_plane";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeEquivalentDiameterCirclesFilter, "f841b59f-c176-4eca-be2b-8e9bdee012c6");
